...
class Carts {
    ...
    async getById(id) {
        try {
            ...
            console.log("Ocurrió un error al realizar la búsqueda en la base de datos, vuelve a intentarlo", error);
        };
    };
    ...
    async createCart(carrito) {
        ...
        try {
            ...
            console.log("Ocurrió un error al intentar almacenar el carrito en la base de datos, vuelve a intentarlo", error);
        };
    };
    ...
    async deleteById(id) {
        try {
            ...
            console.log("Ocurrió un error al intentar eliminar el carrito de la base de datos, vuelve a intentarlo", error);
        };
    };
    ...
    async addProducts(id_cart, product) {
        try {
            ...
            console.log("Ocurrió un error al intentar agregar el producto a la base de datos, vuelve a intentarlo", error);
        };
    };
        ...
        if (cart != undefined) {
            ...
            if (prod != undefined) {
                try {
                    ...
                    console.log("Ocurrió un error al eliminar el producto de la base de datos, vuelve a intentarlo", error);
                };
            } else {
                return undefined;
            };
